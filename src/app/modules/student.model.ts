...
import { Guardian, LocalGuardian, TStudent, StudentInstanceModel, StudentMethodsInstance, UserName } from './student/student.interface';
...
const studentSchema = new Schema<TStudent, StudentInstanceModel, StudentMethodsInstance>({
...
export const Student = model<TStudent, StudentInstanceModel>('Student', studentSchema);
